...
import { Search, ShoppingCart, Loader2, Pill } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center mb-8 bg-white p-4 rounded-xl shadow-sm border border-slate-100">
        ...
        <Link href="/patient/cart" className="relative p-2 bg-teal-50 rounded-full text-teal-700 hover:bg-teal-100 transition">
